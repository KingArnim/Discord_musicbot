...
class ProcessPlayer(Process):
    ...
    async def __createBotInstance(self) -> BkdBot:
        """Load a new bot instance that should not be directly called."""
        initializer = BkdInitializer(willListen=False)
    ...
    async def __ensureDiscordConnection(self, bot: BkdBot) -> None:
