...
from Config.Exceptions import BadCommandUsage, BkdError, ErrorRemoving, InvalidInput, NumberRequired
...
class RemoveHandler(AbstractHandler):
    ...
    def __validateInput(self, position: str) -> Union[BkdError, None]:
        try:
